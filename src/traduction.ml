...
(*Là il y a un truc pénible car on n'a pas les booléens en fouine. Il va falloir modifier ce truc pour généraliser à tous les opérateurs*)
  ...
  (*aspects impératifs*)
      ...
      | Aff(nom, e1)-> let e1 = trad_expr e1 in (0,Let( ((0,Identifier "_"), (0, Fun("s0",(0,Let( ((0,Cart([(0,Identifier "v1");(0,Identifier "s1")])), (0,App((0,Identifier "e1"), (0,Identifier "s0")))), ((0,Let( ((0,Cart([(0,Identifier "v2");(0,Identifier "s2")])), (0,App((0,Identifier "e2"), (0,Identifier "s1")))), ((0,Let( ((0,Identifier "s3"), (0,App((0,App((0,Identifier "modify"), (0,Identifier "s2"))), (0,Cart([(0,Identifier "v1");(0,Identifier "v2")]))))), ((0,Cart([(0,Uni);(0,Identifier "s3")])))))))))))))), ((0, Const 0))))
